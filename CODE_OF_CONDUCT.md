...
[private security advisory](https://github.com/ngsanogo/yagit/security/advisories/new),
which is the only private channel this repository offers. This project has
one maintainer. A report about that person cannot be reviewed here; use
[GitHub's report abuse form](https://github.com/contact/report-abuse)
instead. The same form covers behavior that violates GitHub's own terms.
